...
/* ── Desktop Sidebar ── */
export default function VolunteerSidebar({ navigation, activeKey, activeDelivery }) {
  ...
  return (
    <View style={styles.sidebar}>
      <View style={styles.sidebarHeader}>
        ...
        <Text style={styles.hub}>Volunteer Hub</Text>
      </View>
      ...
      <View style={styles.profileSection}>
        ...
        <View style={styles.profileInfo}>
          <Text style={styles.profileName} numberOfLines={1}>{user?.name || "Volunteer"}</Text>
      ...
      <View style={styles.sidebarNav}>
        ...
        {activeDelivery && (
          <TouchableOpacity
            ...
            style={styles.activeDeliveryItem}
          >
            <Text style={styles.sidebarIcon}>🚚</Text>
            <Text style={styles.sidebarText}>Active Delivery</Text>
          </TouchableOpacity>
        )}
      </View>
    </View>
...
export function VolunteerMobileBottomBar({ navigation, activeKey, activeDelivery }) {
