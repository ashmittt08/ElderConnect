...
const navItems = [
  { key: "NGODashboard", label: "Dashboard", shortLabel: "Home", icon: "📊" },
  { key: "NGOVolunteers", label: "Volunteers", shortLabel: "Vols", icon: "🧑‍🤝‍🧑" },
  { key: "NGORequests", label: "Available Requests", shortLabel: "Reqs", icon: "📋" },
  { key: "EventsScreen", label: "Events", shortLabel: "Events", icon: "📅" },
  { key: "NGOStats", label: "Statistics", shortLabel: "Stats", icon: "📈" },
];
...
/* ── Desktop Sidebar ── */
export default function NGOSidebar({ navigation, activeKey }) {
...
export function NGOMobileBottomBar({ navigation, activeKey }) {
